  ...
  return (
    <Fragment>
      <nav className="NavBar">
        <a href={"/"}>
          <img src={pinterestlogo} className="Pin-Logo" />
        </a>
        <NavLink
          to={"/"}
          exact
          activeClassName="active"
          className="IndexButtons"
        >
          Inicio
        </NavLink>
        <NavLink
        ...
        <a href={"/"}>
          <div className="dropdown">
            <button>
              <img src={dropdownButton} className="Buttons" />
            </button>
        ...
        <a href={"/notifs"}>
          <button>
            <img src={BellButton} className="Buttons" />
          </button>
        </a>
        <a href={"/messages"}>
          <button>
            <img src={MessageButton} className="Buttons" />
          </button>
        </a>
        <a href={"/account"}>
          <button>
            <img src={AccountButton} className="Buttons" />
          </button>
        </a>
      </nav>
    </Fragment>
